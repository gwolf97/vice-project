        ...
        <Row>
            <Col>
                <div className="section-1-container-btm-right d-flex align-items-center flex-column my-5 text-center" >
                    <h3 style={{fontSize:"35px"}} className="section-3-title w-100">Who is our service for?</h3>
                    <p className="section-3-text-1 w-100 mt-1" style={{maxWidth:"800px"}}>
                    ...
                    <p className="section-3-text-2 w-100 mt-2" style={{maxWidth:"800px"}}>
                    ...
                    <Button className="px-5 mt-1 btn-dark btn" variant="dark btn">Teach me how</Button>
                </div>    
            </Col>
        </Row>
    </Container>
